...
__all__ = ['C3k2_WTConv', 'C2f_WTConv']
...
class C2f_WTConv(nn.Module):
    # C2f module with WTConv integrated into Bottleneck blocks.
    ...
    def __init__(self, c1: int, c2: int, n: int = 1, shortcut: bool = False, g: int = 1, e: float = 0.5):
        ...
        # 使用 Bottleneck_WTConv 代替 Bottleneck
        self.m = nn.ModuleList(
            Bottleneck_WTConv(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n)
        )
