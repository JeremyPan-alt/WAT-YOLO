...
import sys
sys.path.append("E:/MachineLearning/yolov11-infrared/ultralytics")  # 添加包所在目录
...
from .modules.PPA import PPA
from .modules.WTConv import C3k2_WTConv
from .modules.FE_WTConv import C3k2_WTConv_Attn_SharedMLP
from .modules.HWD import Down_wt
from .modules.EUCB import EUCB
from .modules.PENet import PENet
from .modules.HAME import HotspotEnhancer
from .modules.HWT_ViT import C3k2_HWT_ViT
from .modules.MSFA import Multibranch, SPDConv
...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            args = [ch[f]]
        elif m in [SHSA, HotspotEnhancer]:
            c1 = ch[f]
            args = [c1, *args[0:]]
        elif m in {EUCB, PENet}:
            c2 = ch[f]
            args = [c2, *args]
